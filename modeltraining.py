...
image_directory = 'D:\Retinopathy\RFMiD\DatasetThree\All/'
df = pd.read_csv('D:\Retinopathy\RFMiD\DatasetThree/RFMiD_Training_Labels_3840.csv') 
# print(df.columns)
SIZE = 128
X_dataset = []

for i in tqdm(range(df.shape[0])):
    image_path = image_directory +str(df['ID'][i])+'.png'
...
conv5 = keras.layers.Conv2D(64, kernel_size=(3, 3), 
                               activation='relu', padding='valid')(conv4)
