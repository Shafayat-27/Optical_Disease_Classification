...
seq = iaa.Sequential([
    iaa.AddToHueAndSaturation((-45, 45))  # Change hue by a value between -45 and +45
])

# Specify the path to the directory containing the images
image_dir = "D:\Retinopathy\RFMiD\AugmentedBrightTrain128"
image_dir_2 = "D:\Retinopathy\RFMiD\AugmentedHueTrain128"
...
for file_name in image_files:
    ...
    for i, augmented_image in enumerate(augmented_images):
        output_file_name = f"HueSat_{file_name}"
